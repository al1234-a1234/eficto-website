...
export function UsersIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
      ...
      <path d="M3.5 20c0-3.6 2.5-6 5.5-6s5.5 2.4 5.5 6M15.5 6.5c1.7.3 3 1.9 3 3.7 0 1.5-.9 2.8-2.1 3.4M17.5 14c2.3.5 3.8 2.5 3.8 5.2" />
    </svg>
  );
}
...
export function StarIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
      <path d="M12 3.5l2.7 5.6 6.1.7-4.5 4.3 1.2 6.1-5.5-3-5.5 3 1.2-6.1-4.5-4.3 6.1-.7L12 3.5Z" />
    </svg>
  );
}
...
export function BellIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="1.6" aria-hidden="true">
      <path d="M6 10a6 6 0 1 1 12 0c0 4 1.3 5.4 1.7 6H4.3C4.7 15.4 6 14 6 10Z" />
