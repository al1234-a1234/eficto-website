...
export default function AccountPage() {
  return (
    <>
      <section className="relative flex h-[38vh] min-h-[260px] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <h1 className="mt-4 font-arabic-display text-5xl text-eficto-cream">حسابي</h1>
        </div>
      </section>
