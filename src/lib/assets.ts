const RAW_BASE =
  "https://raw.githubusercontent.com/al1234-a1234/eficto-website/claude/eficto-restaurant-site-dznadt/public";

export const IMAGES = {
  interiorArch: `${RAW_BASE}/images/interior-arch.jpg`,
  interiorBooth: `${RAW_BASE}/images/interior-booth.jpg`,
  floorLogo: `${RAW_BASE}/images/floor-logo.jpg`,
};
